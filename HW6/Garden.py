...
# Homework
class LivingPests(Pests):
    def __init__(self, pests_type, quantity):
        super(LivingPests, self).__init__(pests_type, quantity)
        self.pests_type = pests_type
        self.quantity = quantity
...
# Creating list of instances for vegetables and fruits, pests and gardener
    tomato_bush = TomatoBush(11)
    print(tomato_bush.__dict__)
    apple_tree = AppleTree(3)
    pests = LivingPests('worm', 10)
